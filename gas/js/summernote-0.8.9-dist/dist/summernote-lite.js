...
$$1.extend($$1.summernote.lang, {
    'en-US': {
        ...
        image: {
            ...
            resizeFull: '전체 크기 조정',
            resizeHalf: '절반 크기 조정',
            resizeQuarter: '1/4 크기 조정',
            floatLeft: '왼쪽으로',
            floatRight: '오른쪽으로',
            floatNone: '없음',
            shapeRounded: '모양 : 굴곡',
            shapeCircle: '모양 : 원형',
            shapeThumbnail: '모양: 섬네일',
            shapeNone: '모양 : 없음',
            dragImageHere: '이미지 또는 텍스트를 여기로 드래그하십시오.',
            dropImage: '이미지 또는 텍스트 놓기',
        ...
        link: {
            ...
            unlink: '링크 제거',
            edit: '편집',
            textToDisplay: '표시 할 텍스트',
            url: '이동할 링크 주소',
            openInNewWindow: '새윈도우에서 열기'
        },
        table: {
            table: '테이블',
            addRowAbove: '위에 행 추가',
