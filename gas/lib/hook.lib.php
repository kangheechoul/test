...
define('BD_HOOK_DEFAULT_PRIORITY', 8);
...
function add_event($tag, $func, $priority=BD_HOOK_DEFAULT_PRIORITY, $args=0){
...
function add_replace($tag, $func, $priority=BD_HOOK_DEFAULT_PRIORITY, $args=0){
...
function delete_event($tag, $func, $priority=BD_HOOK_DEFAULT_PRIORITY){
...
function delete_replace($tag, $func, $priority=BD_HOOK_DEFAULT_PRIORITY){
